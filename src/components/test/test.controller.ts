...
import { client, listTables, documentClient } from '../../config/db.config';
...
import {
	...
	ISystemInfoResponse,
} from '../system-status/system-status.types';


/**
 * Status controller
 */
export default class TestController extends BaseApi {
	/**
	 *
	 */
	constructor() {
	...
	public register(): Router {
		...
		this.router.get('/read', this.getDynamodbData.bind(this));
    ...
    public async getDynamodbData(
		...
		try {
            ...
            const singleTableData = (await documentClient.scan(params)).Items;
            
            const tableList = (await client.send(listTables)).TableNames;
            
            // const singleRowData = (await documentClient.get({
            //     TableName: 'table-name',
            //     Key: {
            //         Id: '2907917|594fe2c1-9e1c-4f78-8379-bee6bc8a6b93',
            //     },
            // })).Item;
